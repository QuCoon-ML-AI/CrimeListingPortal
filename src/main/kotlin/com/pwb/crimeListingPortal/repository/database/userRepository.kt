...
import com.pwb.crimeListingPortal.repository.database.query.UserQuery
...
interface UserRepository{
	...
	fun readByUserRole(userRole: String):MutableList<User>
...
class UserRepositoryImpl(private val environment: Environment): UserRepository{
	...
	override fun readByUserRole(userRole: String):MutableList<User>{
		return environment.databaseUtil?.sql2oConnection!!
				.createQueryWithoutOnMappingFailure(UserQuery.READ_BY_USER_ROLE)
